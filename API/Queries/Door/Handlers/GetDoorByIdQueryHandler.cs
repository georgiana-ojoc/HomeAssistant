...
{
    public class GetDoorByIdQueryHandler : Handler, IRequestHandler<GetDoorByIdQuery, Shared.Models.Door>
    {
        ...
        public async Task<Shared.Models.Door> Handle(GetDoorByIdQuery request, CancellationToken cancellationToken)
        {
