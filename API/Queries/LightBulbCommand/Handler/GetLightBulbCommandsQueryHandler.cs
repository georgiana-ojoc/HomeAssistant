...
{
    public class GetLightBulbCommandsQueryHandler:API.Handler,IRequestHandler<GetLightBulbCommandsQuery,IEnumerable<Shared.Models.LightBulbCommand>>
    {
        private readonly ILightBulbCommandRepository _repository;

        public GetLightBulbCommandsQueryHandler(Identity identity, ILightBulbCommandRepository repository) : base(identity)
        {
