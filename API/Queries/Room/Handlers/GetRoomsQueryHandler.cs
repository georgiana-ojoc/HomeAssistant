...
{
    public class GetRoomsQueryHandler : Handler, IRequestHandler<GetRoomsQuery, IEnumerable<Shared.Models.Room>>
    {
        ...
        public async Task<IEnumerable<Shared.Models.Room>> Handle(GetRoomsQuery request,
