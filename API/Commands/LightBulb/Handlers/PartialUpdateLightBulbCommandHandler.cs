...
namespace API.Commands.LightBulb.Handlers
{
    public class PartialUpdateLightBulbCommandHandler : Handler,
        IRequestHandler<PartialUpdateLightBulbCommand, Shared.Models.LightBulb>
    {
        ...
        public async Task<Shared.Models.LightBulb> Handle(PartialUpdateLightBulbCommand request,
