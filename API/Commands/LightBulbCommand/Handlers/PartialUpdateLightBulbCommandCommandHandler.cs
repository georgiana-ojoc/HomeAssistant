...
namespace API.Commands.LightBulbCommand.Handlers
{
    public class PartialUpdateLightBulbCommandCommandHandler : Handler,
        IRequestHandler<PartialUpdateLightBulbCommandCommand, Shared.Models.LightBulbCommand>
    {
        ...
        public async Task<Shared.Models.LightBulbCommand> Handle(PartialUpdateLightBulbCommandCommand request,
