...
{
    public class DeleteLightBulbCommandHandler : Handler,
        IRequestHandler<DeleteLightBulbCommand, Shared.Models.LightBulbCommand>
    {
        ...
        public async Task<Shared.Models.LightBulbCommand> Handle(DeleteLightBulbCommand request,
