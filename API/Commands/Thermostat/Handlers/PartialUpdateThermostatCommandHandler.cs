...
namespace API.Commands.Thermostat.Handlers
{
    public class PartialUpdateThermostatCommandHandler : Handler,
        IRequestHandler<PartialUpdateThermostatCommand, Shared.Models.Thermostat>
    {
        ...
        public async Task<Shared.Models.Thermostat> Handle(PartialUpdateThermostatCommand request,
